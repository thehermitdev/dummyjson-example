...
function DashboardRoute() {
  ...
  return <DashboardPage totals={{ users: users.total, posts: posts.total, carts: carts.total, todos: todos.total }} recentUsers={users.users.map(({ id, firstName, lastName, email, image }) => ({ id, firstName, lastName, email, image }))} />;
}
