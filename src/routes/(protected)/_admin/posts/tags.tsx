...
function TagsRoute() {
  const tags = useSuspenseQuery(postTagsQueryOptions()).data;
  const tagList = useSuspenseQuery(postTagListQueryOptions()).data;
  return <PostTagsPage tags={tags} tagList={tagList} />;
}
